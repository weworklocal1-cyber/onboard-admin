...
import { BookOpen, GraduationCap, Award, ClipboardList, Settings, LogOut, Menu, X, DollarSign, CreditCard, Receipt, Wallet, MessageSquare } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { name: "Applicants", href: "/admin/applicants", icon: <GraduationCap className="h-5 w-5" /> },
  { name: "Message Templates", href: "/admin/applicants/templates", icon: <MessageSquare className="h-5 w-5" /> },
