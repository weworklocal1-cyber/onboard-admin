    ...
    <html>
        ...
        <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .header::after {
            ...
            right: 0;
            height: 3px;
            background: linear-gradient(90deg, #059669, #0891b2, #059669);
          }
          .header-inner {
            display: flex;
      ...
      <body>
        <div class="certificate">
          ...
          <div class="footer">
            <div class="footer-text">Powered by LocalWala & WeWorkLocal | Verify at localwala.tech/academy/certificates/verify/${certificate.certificate_id}</div>
          </div>
        </div>
      </body>
    </html>
